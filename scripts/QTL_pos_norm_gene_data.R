...
posns <- qtls |>
    select(gene_id, modality, rel_pos_gene, rel_pos_TSS, rel_pos_TES,
           rel_pos_exon, rel_pos_intron, rel_pos_ex_in_bnd, rel_pos_in_ex_bnd)

write_tsv(posns, "data/processed/geuvadis.comb.qtls.rel_pos.tsv")
